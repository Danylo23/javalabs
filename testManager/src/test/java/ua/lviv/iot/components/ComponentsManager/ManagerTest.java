...
class ManagerTest {
    ...
    void setUp() throws Exception {
        components.add(new CoolingSystem("Asus", 500, 25, 2016));
        components.add(new HDD("Toshiba", 1000, 32, 2018));
        components.add(new MotherBoard("Asus", 3000, 60, 2019));
        components.add(new PowerSupply("GameMax", 500, 55, 2015));
        components.add(new Processor("AMD", 6000, 20, 2016));
