...
public class Main {
    public static void main(String[] args) {
        List<Components> products = new ArrayList<>();
        products.add(new CoolingSystem("Asus", 500, 25, 2016));
        products.add(new HDD("Toshiba", 1000, 32, 2018));
        products.add(new MotherBoard("Asus", 3000, 60, 2019));
        products.add(new PowerSupply("GameMax", 500, 55, 2015));
        products.add(new Processor("AMD", 6000, 20, 2016));
        products.add(new RAM("HyperX", 3000, 5, 2018));
        products.add(new VideoCard("Asus", 12500, 40, 2016));
